...
if __name__ == "__main__":
    path = "../BrainTumorSegmentation/dataset"
    images, masks = load_data(path)
    print(f"Original Images: {len(images)} - Original Masks: {len(masks)}")

    """ Creating folders. """
    create_dir("Augmented_Data/images")
    create_dir("Augmented_Data/masks")

    """Augmenting the data"""
    augment_data(images, masks, "Augmented_Data")

    """Loading the augmented data"""
    images, masks = load_data("Augmented_Data")
